(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@casl/ability'))
    : typeof define === 'function' && define.amd ? define(['exports', '@casl/ability'], factory)
      : (global = global || self, factory((global.casl = global.casl || {}, global.casl.vue = {}), global.casl));
}(this, (exports, ability) => {
  const can = {
    name: 'Can',
    functional: true,
    props: {
  ...
  function abilitiesPlugin(Vue, providedAbility) {
    const defaultAbility = providedAbility || new ability.Ability([]);
